...
module.exports = {
    content: ['./src/**/*.{html,ts}', './node_modules/@devlab-ys/angular-components/**/*.{html,ts}'],
    darkMode: 'class',
    prefix: 'tw-',
    theme: {
        extend: {
    ...
    safelist: [
        {
            pattern:
                /(bg|text|border)-(primary|secondary|tertiary|success|warning|danger|background-primary|background-secondary|background-tertiary|text-primary|text-secondary|transparent)/,
